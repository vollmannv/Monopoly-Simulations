...
for i in tqdm(range(games)):
    ...
    player2 = pl.Player(1, 'Player 2', 400, 1.5, 0.40, buysBahn=False)
    player3 = pl.Player(1, 'Player 3', 400, 1.5, 0.40, buysWerk=False)
    player4 = pl.Player(1, 'Player 4', 400, 1.5, 0.40, buysBahn=False, buysWerk=False)
    streets = []
    ereignisFelder = []
    gemeinschaftsFelder = []
    bahnhoefe = []
